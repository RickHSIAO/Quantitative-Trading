...
Usage (DISABLED IMPLEMENTATION SCAFFOLD MANUAL AUTHORIZATION GATE FINAL PRE-EXECUTION REVIEW CHECKLIST --- default, no network,
       no implementation, no execution):
  python scripts/preview_demo_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review.py \\
...
Writes (when --write-report):
  outputs/demo_trading/tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review/
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review.json
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review.md
      latest_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review.json
      latest_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review.md

IMPORTANT:
  - TASK-014BA produces a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-MANUAL-AUTHORIZATION-GATE-FINAL-PRE-EXECUTION-REVIEW-ONLY artifact.
...
Exit codes:
  0  tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review_ready /
     tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review_ready_but_execution_disabled /
...
_DEFAULT_OUTPUT_DIR          = (
    ...
    / "outputs"
    / "demo_trading"
    / "tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review"
)
...
def _write_report(
    ...
    md_lines: list[str] = [
        ...
        f"disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review_conclusion: `{r.implementation_design_conclusion}`  ",
        f"disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review_authorization_result: `{r.implementation_design_authorization_result}`  ",
        ...
        "",
        "## Disabled Implementation Scaffold Manual Authorization Gate Final Pre-Execution Review Verdict",
        "",
        "| field | value |",
        "|---|---|",
        ...
        "```",
        "",
        "## Final Disabled Implementation Scaffold Manual Authorization Gate Final Pre-Execution Review Verdict",
        "",
        "```json",
    ...
    md_lines += [
        ...
        "",
        "> TASK-014BA is a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-MANUAL-AUTHORIZATION-GATE-FINAL-PRE-EXECUTION-REVIEW-ONLY module.",
...
def run_execute(
    ...
    if allow_real_entry_execution:
        ...
        print("DISABLED IMPLEMENTATION SCAFFOLD MANUAL AUTHORIZATION GATE FINAL PRE-EXECUTION REVIEW APPROVAL --- NO NETWORK --- final-pre-execution-review-only")
    else:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "IMPLEMENTATION SCAFFOLD MANUAL AUTHORIZATION GATE FINAL PRE-EXECUTION REVIEW (TASK-014BA).  Consumes "
            ...
            "manual authorization gate final pre-execution review for TASK-014BB.  No network, no live endpoint, no orders / "
    ...
    parser.add_argument("--allow-disabled-implementation-scaffold-manual-authorization-gate-final-pre-execution-review",
                        ...
                        help=("Promote envelope to disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review_approval. "
                              "Even with this flag, TASK-014BA only emits a "
                              "static-skeleton dry-run artifact "
                              "(disabled_implementation_scaffold_manual_authorization_gate_final_pre_execution_review_conclusion stays "
                              "DISABLED_IMPLEMENTATION_SCAFFOLD_MANUAL_AUTHORIZATION_GATE_FINAL_PRE_EXECUTION_REVIEW_READY_NOT_EXECUTABLE).  "
    ...
    parser.add_argument("--allow-real-entry-execution", action="store_true",
                        help=("Guarded flag for a hypothetical future real "
                              "tiny entry sender execution.  TASK-014BA "
