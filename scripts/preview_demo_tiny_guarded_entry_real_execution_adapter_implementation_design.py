"""
scripts/preview_demo_tiny_guarded_entry_real_execution_adapter_implementation_design.py
TASK-014AQ: Guarded Entry Real Execution Adapter Implementation
            Design CLI.

Usage (IMPLEMENTATION DESIGN CHECKLIST --- default, no network,
       no implementation, no execution):
  python scripts/preview_demo_tiny_guarded_entry_real_execution_adapter_implementation_design.py \\
...
Writes (when --write-report):
  outputs/demo_trading/tiny_guarded_entry_real_execution_adapter_implementation_design/
      {ts}_tiny_guarded_entry_real_execution_adapter_implementation_design.json
      {ts}_tiny_guarded_entry_real_execution_adapter_implementation_design.md
      latest_tiny_guarded_entry_real_execution_adapter_implementation_design.json
      latest_tiny_guarded_entry_real_execution_adapter_implementation_design.md

IMPORTANT:
  - TASK-014AQ produces a STRICT IMPLEMENTATION-DESIGN-ONLY artifact.
    ...
    design for the FUTURE TASK-014AR adapter static skeleton design
...
Exit codes:
  0  tiny_guarded_entry_real_execution_adapter_implementation_design_ready /
     tiny_guarded_entry_real_execution_adapter_implementation_design_ready_but_execution_disabled /
...
from src.demo_tiny_guarded_entry_real_execution_adapter_implementation_design import (
    ...
    DemoTinyGuardedEntryRealExecutionAdapterImplementationDesign,
    TinyGuardedEntryRealExecutionAdapterImplementationDesignResult,
...
def _print_result(
    r: TinyGuardedEntryRealExecutionAdapterImplementationDesignResult,
) -> None:
...
def _write_report(
    ...
    base = "tiny_guarded_entry_real_execution_adapter_implementation_design"
    ...
    md_lines: list[str] = [
        "# Tiny Guarded Entry Real Execution Adapter Implementation Design (TASK-014AQ)",
        "",
    ...
    md_lines += [
        ...
        "",
        "> TASK-014AQ is a STRICT IMPLEMENTATION-DESIGN-ONLY module.",
...
def run_execute(
    ...
    print("TASK-014AQ: Guarded Entry Real Execution Adapter Implementation Design")
    ...
    gate = DemoTinyGuardedEntryRealExecutionAdapterImplementationDesign()
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "design for the FUTURE TASK-014AR adapter static "
            "skeleton design.  Even with --allow-implementation-design "
            "this only emits a design artifact; even with "
    ...
    parser.add_argument("--expected-commit-hash", default="",
                        ...
                        help=("Optional expected commit hash to record in the "
                              ...
                              "git commit or push)."))
    parser.add_argument("--allow-implementation-design", action="store_true",
                        help=("Promote envelope to implementation_design_approval. "
                              "Even with this flag, TASK-014AQ only emits an "
                              "implementation-design artifact "
                              "(implementation_design_conclusion stays "
    ...
    parser.add_argument("--allow-real-entry-execution", action="store_true",
                        help=("Guarded flag for a hypothetical future real "
                              "tiny entry sender execution.  TASK-014AQ "
