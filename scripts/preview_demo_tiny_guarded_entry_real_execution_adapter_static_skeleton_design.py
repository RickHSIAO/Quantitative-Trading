...
Writes (when --write-report):
  outputs/demo_trading/tiny_guarded_entry_real_execution_adapter_static_skeleton_design/
      {ts}_tiny_guarded_entry_real_execution_adapter_static_skeleton_design.json
      {ts}_tiny_guarded_entry_real_execution_adapter_static_skeleton_design.md
...
Exit codes:
  0  tiny_guarded_entry_real_execution_adapter_static_skeleton_design_ready /
     tiny_guarded_entry_real_execution_adapter_static_skeleton_design_ready_but_execution_disabled /
...
def _print_result(
    r: TinyGuardedEntryRealExecutionAdapterStaticSkeletonDesignResult,
) -> None:
...
def _write_report(
    ...
    md_lines += [
        ...
        "",
        "> TASK-014AR is a STRICT IMPLEMENTATION-DESIGN-ONLY module.",
...
def main() -> None:
    ...
    parser.add_argument("--allow-implementation-design", action="store_true",
                        help=("Promote envelope to implementation_design_approval. "
                              "Even with this flag, TASK-014AR only emits an "
    ...
    parser.add_argument("--allow-real-entry-execution", action="store_true",
                        help=("Guarded flag for a hypothetical future real "
                              "tiny entry sender execution.  TASK-014AR "
