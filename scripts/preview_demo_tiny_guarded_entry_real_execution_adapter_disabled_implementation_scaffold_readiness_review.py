...
Writes (when --write-report):
  outputs/demo_trading/tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_readiness_review/
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_readiness_review.json
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_readiness_review.md
...
IMPORTANT:
  ...
  - Even with --allow-disabled-implementation-scaffold-readiness-review the module only emits
    a sanitized dry-run artifact.  disabled_implementation_scaffold_readiness_review_conclusion
    is fixed at DISABLED_IMPLEMENTATION_SCAFFOLD_READINESS_REVIEW_READY_NOT_EXECUTABLE.
...
Exit codes:
  0  tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_readiness_review_ready /
     tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_readiness_review_ready_but_execution_disabled /
...
def _print_result(
    r: TinyGuardedEntryRealExecutionAdapterDisabledImplementationScaffoldReadinessReviewResult,
) -> None:
...
def _write_report(
    ...
    md_lines: list[str] = [
        ...
        f"disabled_implementation_scaffold_readiness_review_conclusion: `{r.implementation_design_conclusion}`  ",
        f"disabled_implementation_scaffold_readiness_review_authorization_result: `{r.implementation_design_authorization_result}`  ",
        ...
        "",
        "## Disabled Implementation Scaffold Readiness Review Verdict",
        "",
        "| field | value |",
        "|---|---|",
        ...
        "",
        "## Disabled Implementation Scaffold Readiness Review Scope",
        "",
        "```json",
        ...
        "```",
        "",
        "## Final Disabled Implementation Scaffold Readiness Review Verdict",
        "",
        "```json",
    ...
    md_lines += [
        ...
        "> Even with --allow-disabled-implementation-scaffold-readiness-review the module",
        "> only emits a sanitized dry-run artifact",
        "> (disabled_implementation_scaffold_readiness_review_conclusion remains",
        "> DISABLED_IMPLEMENTATION_SCAFFOLD_READINESS_REVIEW_READY_NOT_EXECUTABLE).  Even with",
...
def run_execute(
    ...
    gate = DemoTinyGuardedEntryRealExecutionAdapterDisabledImplementationScaffoldReadinessReview()
...
def main() -> None:
    ...
    parser.add_argument("--expected-commit-hash", default="",
                        ...
                        help=("Optional expected commit hash to record in the "
                              ...
                              "git commit or push)."))
    parser.add_argument("--allow-disabled-implementation-scaffold-readiness-review",
                        dest="allow_implementation_design",
                        action="store_true",
                        help=("Promote envelope to disabled_implementation_scaffold_readiness_review_approval. "
                              "Even with this flag, TASK-014AV only emits a "
                              "static-skeleton dry-run artifact "
                              "(disabled_implementation_scaffold_readiness_review_conclusion stays "
                              "DISABLED_IMPLEMENTATION_SCAFFOLD_READINESS_REVIEW_READY_NOT_EXECUTABLE).  "
    ...
    parser.add_argument("--allow-real-entry-execution", action="store_true",
                        help=("Guarded flag for a hypothetical future real "
                              "tiny entry sender execution.  TASK-014AV "
