...
Usage (DISABLED IMPLEMENTATION SCAFFOLD DRY-RUN CHECKLIST --- default, no network,
  ...
  python scripts/preview_demo_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run.py \\
...
Usage (DISABLED IMPLEMENTATION SCAFFOLD DRY-RUN APPROVAL --- dry-run-only, no execution):
  ... --allow-disabled-implementation-scaffold-dry-run
...
Writes (when --write-report):
  outputs/demo_trading/tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run/
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run.json
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run.md
      latest_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run.json
      latest_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run.md

IMPORTANT:
  - TASK-014AU produces a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-DRY-RUN-ONLY artifact.
    ...
    scaffold design for the FUTURE TASK-014AV adapter disabled
  ...
  - Even with --allow-disabled-implementation-scaffold-dry-run the module only emits
    a sanitized dry-run artifact.  disabled_implementation_scaffold_dry_run_conclusion
    is fixed at DISABLED_IMPLEMENTATION_SCAFFOLD_DRY_RUN_READY_NOT_EXECUTABLE.
...
Exit codes:
  0  tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run_ready /
     tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_dry_run_ready_but_execution_disabled /
...
def _print_result(
    r: TinyGuardedEntryRealExecutionAdapterDisabledImplementationScaffoldDryRunResult,
) -> None:
...
def _write_report(
    ...
    md_lines: list[str] = [
        ...
        f"disabled_implementation_scaffold_dry_run_conclusion: `{r.implementation_design_conclusion}`  ",
        f"disabled_implementation_scaffold_dry_run_authorization_result: `{r.implementation_design_authorization_result}`  ",
        ...
        "",
        "## Disabled Implementation Scaffold Dry-run Verdict",
        "",
        "| field | value |",
        "|---|---|",
        ...
        "",
        "## Disabled Implementation Scaffold Dry-run Scope",
        "",
        "```json",
        ...
        "```",
        "",
        "## Final Disabled Implementation Scaffold Dry-run Verdict",
        "",
        "```json",
    ...
    md_lines += [
        ...
        "",
        "> TASK-014AU is a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-DRY-RUN-ONLY module.",
        ...
        "> Even with --allow-disabled-implementation-scaffold-dry-run the module",
        "> only emits a sanitized dry-run artifact",
        "> (disabled_implementation_scaffold_dry_run_conclusion remains",
        "> DISABLED_IMPLEMENTATION_SCAFFOLD_DRY_RUN_READY_NOT_EXECUTABLE).  Even with",
...
def run_execute(
    ...
    gate = DemoTinyGuardedEntryRealExecutionAdapterDisabledImplementationScaffoldDryRun()
    result = gate.run_dry_run(
...
def main() -> None:
    ...
    parser.add_argument("--expected-commit-hash", default="",
                        ...
                        help=("Optional expected commit hash to record in the "
                              ...
                              "git commit or push)."))
    parser.add_argument("--allow-disabled-implementation-scaffold-dry-run",
                        dest="allow_implementation_design",
                        action="store_true",
                        help=("Promote envelope to disabled_implementation_scaffold_dry_run_approval. "
                              "Even with this flag, TASK-014AU only emits a "
                              "static-skeleton dry-run artifact "
                              "(disabled_implementation_scaffold_dry_run_conclusion stays "
                              "DISABLED_IMPLEMENTATION_SCAFFOLD_DRY_RUN_READY_NOT_EXECUTABLE).  "
    ...
    parser.add_argument("--allow-real-entry-execution", action="store_true",
                        help=("Guarded flag for a hypothetical future real "
                              "tiny entry sender execution.  TASK-014AU "
