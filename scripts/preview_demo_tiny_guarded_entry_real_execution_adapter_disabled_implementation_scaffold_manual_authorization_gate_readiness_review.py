...
Usage (DISABLED IMPLEMENTATION SCAFFOLD MANUAL AUTHORIZATION GATE READINESS REVIEW CHECKLIST --- default, no network,
       no implementation, no execution):
  python scripts/preview_demo_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_readiness_review.py \\
...
Writes (when --write-report):
  outputs/demo_trading/tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_readiness_review/
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_readiness_review.json
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_readiness_review.md
      ...
      latest_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_readiness_review.md

IMPORTANT:
  - TASK-014AZ produces a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-MANUAL-AUTHORIZATION-GATE-READINESS-REVIEW-ONLY artifact.
    ...
    scaffold manual authorization gate readiness review for the FUTURE TASK-014AZ adapter
    disabled implementation scaffold manual authorization gate readiness review
  ...
  - Even with --allow-disabled-implementation-scaffold-manual-authorization-gate-readiness-review the module only emits
    a sanitized dry-run artifact.  disabled_implementation_scaffold_manual_authorization_gate_readiness_review_conclusion
    is fixed at DISABLED_IMPLEMENTATION_SCAFFOLD_MANUAL_AUTHORIZATION_GATE_READINESS_REVIEW_READY_NOT_EXECUTABLE.
...
Exit codes:
  0  tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_readiness_review_ready /
     tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_manual_authorization_gate_readiness_review_ready_but_execution_disabled /
...
def load_latest_entry_disabled_implementation_scaffold_manual_authorization_gate_dry_run(
    entry_disabled_implementation_scaffold_manual_authorization_gate_dry_run_dir: Path,
) -> dict | None:
    """Load the latest TASK-014AY manual authorization gate dry-run artifact.

    TASK-014AZ's direct upstream. The artifact carries AX's manual
...
def _write_report(
    ...
    md_lines: list[str] = [
        "# Tiny Guarded Entry Real Execution Adapter Disabled Implementation Scaffold Manual Authorization Gate Readiness Review (TASK-014AZ)",
        "",
        "_TASK-014AZ consumes TASK-014AY disabled implementation scaffold manual authorization gate dry-run output at "
        "runtime and produces a disabled implementation scaffold manual authorization gate readiness review for TASK-014BA. "
        ...
        f"disabled_implementation_scaffold_manual_authorization_gate_readiness_review_conclusion: `{r.implementation_design_conclusion}`  ",
        f"disabled_implementation_scaffold_manual_authorization_gate_readiness_review_authorization_result: `{r.implementation_design_authorization_result}`  ",
        ...
        "",
        "## Disabled Implementation Scaffold Manual Authorization Gate Readiness Review Verdict",
        "",
        "| field | value |",
        "|---|---|",
        ...
        "```",
        "",
        "## Final Disabled Implementation Scaffold Manual Authorization Gate Readiness Review Verdict",
        "",
        "```json",
    ...
    md_lines += [
        ...
        "",
        "> TASK-014AZ is a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-MANUAL-AUTHORIZATION-GATE-READINESS-REVIEW-ONLY module.",
        ...
        "> (disabled_implementation_scaffold_manual_authorization_gate_readiness_review_conclusion remains",
        "> DISABLED_IMPLEMENTATION_SCAFFOLD_MANUAL_AUTHORIZATION_GATE_READINESS_REVIEW_READY_NOT_EXECUTABLE).  Even with",
...
def run_execute(
    ...
    if allow_real_entry_execution:
        ...
        print("DISABLED IMPLEMENTATION SCAFFOLD MANUAL AUTHORIZATION GATE READINESS REVIEW APPROVAL --- NO NETWORK --- readiness-review-only")
    else:
        print("DISABLED IMPLEMENTATION SCAFFOLD MANUAL AUTHORIZATION GATE READINESS REVIEW CHECKLIST --- NO NETWORK --- readiness-review-only")
    print("TASK-014AZ: Guarded Entry Real Execution Adapter Disabled Implementation Scaffold Manual Authorization Gate Readiness Review")
    print("  consumes TASK-014AY disabled implementation scaffold manual authorization gate dry-run output -> produces disabled implementation scaffold manual authorization gate readiness review for TASK-014BA")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "IMPLEMENTATION SCAFFOLD MANUAL AUTHORIZATION GATE READINESS REVIEW (TASK-014AZ).  Consumes "
            ...
            "manual authorization gate readiness review for TASK-014BA.  No network, no live endpoint, no orders / "
            ...
            "scaffold manual authorization gate readiness review for the FUTURE TASK-014AZ adapter "
            "disabled implementation scaffold manual authorization gate readiness review.  Even with "
            "--allow-disabled-implementation-scaffold-manual-authorization-gate-readiness-review "
    ...
    parser.add_argument("--allow-disabled-implementation-scaffold-manual-authorization-gate-readiness-review",
                        ...
                        action="store_true",
                        help=("Promote envelope to disabled_implementation_scaffold_manual_authorization_gate_readiness_review_approval. "
                              "Even with this flag, TASK-014AZ only emits a "
                              "static-skeleton dry-run artifact "
                              "(disabled_implementation_scaffold_manual_authorization_gate_readiness_review_conclusion stays "
                              "DISABLED_IMPLEMENTATION_SCAFFOLD_MANUAL_AUTHORIZATION_GATE_READINESS_REVIEW_READY_NOT_EXECUTABLE).  "
    ...
    parser.add_argument("--allow-real-entry-execution", action="store_true",
                        help=("Guarded flag for a hypothetical future real "
                              "tiny entry sender execution.  TASK-014AZ "
