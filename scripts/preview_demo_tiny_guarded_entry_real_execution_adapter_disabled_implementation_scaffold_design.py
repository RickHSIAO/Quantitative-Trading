...
Usage (DISABLED IMPLEMENTATION SCAFFOLD DESIGN CHECKLIST --- default, no network,
       no implementation, no execution):
  python scripts/preview_demo_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design.py \\
...
Usage (DISABLED IMPLEMENTATION SCAFFOLD DESIGN APPROVAL --- dry-run-only, no execution):
  ... --allow-disabled-implementation-scaffold-design
...
Writes (when --write-report):
  outputs/demo_trading/tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design/
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design.json
      {ts}_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design.md
      latest_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design.json
      latest_tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design.md

IMPORTANT:
  - TASK-014AT produces a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-DESIGN-ONLY artifact.
    ...
    scaffold design for the FUTURE TASK-014AU adapter disabled
  ...
  - Even with --allow-disabled-implementation-scaffold-design the module only emits
    a sanitized dry-run artifact.  disabled_implementation_scaffold_design_conclusion
    is fixed at DISABLED_IMPLEMENTATION_SCAFFOLD_DESIGN_READY_NOT_EXECUTABLE.
...
Exit codes:
  0  tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design_ready /
     tiny_guarded_entry_real_execution_adapter_disabled_implementation_scaffold_design_ready_but_execution_disabled /
...
def _print_result(
    r: TinyGuardedEntryRealExecutionAdapterDisabledImplementationScaffoldDesignResult,
) -> None:
    ...
    print(f"  upstream_entry_adapter_dry_run_design_grants  : "
          f"{r.upstream_entry_adapter_dry_run_design_grants_execution}")
...
def _write_report(
    ...
    md_lines: list[str] = [
        "# Tiny Guarded Entry Real Execution Adapter Disabled Implementation Scaffold Design (TASK-014AT)",
        "",
        "_TASK-014AT consumes TASK-014AS static skeleton dry-run output at "
        "runtime and produces a disabled implementation scaffold design for TASK-014AU. "
        ...
        f"disabled_implementation_scaffold_design_conclusion: `{r.implementation_design_conclusion}`  ",
        f"disabled_implementation_scaffold_design_authorization_result: `{r.implementation_design_authorization_result}`  ",
        ...
        "",
        "## Disabled Implementation Scaffold Design Verdict",
        "",
        "| field | value |",
        "|---|---|",
        ...
        "",
        "## Disabled Implementation Scaffold Design Scope",
        "",
        "```json",
        ...
        "```",
        "",
        "## Final Disabled Implementation Scaffold Design Verdict",
        "",
        "```json",
    ...
    md_lines += [
        ...
        "",
        "> TASK-014AT is a STRICT DISABLED-IMPLEMENTATION-SCAFFOLD-DESIGN-ONLY module.",
        ...
        "> Even with --allow-disabled-implementation-scaffold-design the module",
        "> only emits a sanitized dry-run artifact",
        "> (disabled_implementation_scaffold_design_conclusion remains",
        "> DISABLED_IMPLEMENTATION_SCAFFOLD_DESIGN_READY_NOT_EXECUTABLE).  Even with",
...
def run_execute(
    ...
    if allow_real_entry_execution:
        ...
        print("DISABLED IMPLEMENTATION SCAFFOLD DESIGN APPROVAL --- NO NETWORK --- dry-run-only")
    else:
        print("DISABLED IMPLEMENTATION SCAFFOLD DESIGN CHECKLIST --- NO NETWORK --- dry-run-only")
    print("TASK-014AT: Guarded Entry Real Execution Adapter Disabled Implementation Scaffold Design")
    print("  consumes TASK-014AS static skeleton dry-run output -> produces disabled implementation scaffold design for TASK-014AU")
    ...
    gate = DemoTinyGuardedEntryRealExecutionAdapterDisabledImplementationScaffoldDesign()
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "IMPLEMENTATION SCAFFOLD DESIGN (TASK-014AT).  Consumes "
            "TASK-014AS static skeleton dry-run output at runtime and "
            "produces a disabled implementation scaffold design for "
            "TASK-014AU.  No network, no live endpoint, no orders / "
            ...
            "scaffold design for the FUTURE TASK-014AU adapter disabled "
            "implementation scaffold dry-run.  Even with "
            "--allow-disabled-implementation-scaffold-design "
    ...
    parser.add_argument("--expected-commit-hash", default="",
                        ...
                        help=("Optional expected commit hash to record in the "
                              ...
                              "git commit or push)."))
    parser.add_argument("--allow-disabled-implementation-scaffold-design",
                        dest="allow_implementation_design",
                        action="store_true",
                        help=("Promote envelope to disabled_implementation_scaffold_design_approval. "
                              "Even with this flag, TASK-014AT only emits a "
                              "static-skeleton dry-run artifact "
                              "(disabled_implementation_scaffold_design_conclusion stays "
                              "DISABLED_IMPLEMENTATION_SCAFFOLD_DESIGN_READY_NOT_EXECUTABLE).  "
    ...
    parser.add_argument("--allow-real-entry-execution", action="store_true",
                        help=("Guarded flag for a hypothetical future real "
                              "tiny entry sender execution.  TASK-014AT "
