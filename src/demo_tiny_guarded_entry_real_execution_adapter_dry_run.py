"""
src/demo_tiny_guarded_entry_real_execution_adapter_dry_run.py
TASK-014AO: Guarded Entry Real Execution Adapter Dry-run.

Adapter-dry-run-only module. This task consumes TASK-014AN's adapter
design output and simulates the FUTURE real tiny entry execution
adapter end-to-end (input validation simulation / request envelope /
payload preview / simulated response / secret-and-signature boundary
/ stop-cleanup boundary / forbidden surface / failure-and-abort
documentation) without invoking any sender, opening any socket,
reading any secret, or signing any request. This module DOES NOT
implement the adapter, does not import any sender / private client /
network primitive, does not call /v5/order/create, does not call
...
Inputs: 24 upstream artifacts (the 23 from TASK-014AN + AN's own
        guarded entry real execution adapter design output).
...
Modes:
  adapter_dry_run_checklist  --- default
  adapter_dry_run_approval   --- --allow-adapter-dry-run
...
STAGE_1_ADAPTER_DRY_RUN_SCOPE                 = "stage_1_adapter_dry_run_scope"
STAGE_2_ADAPTER_DRY_RUN_CONTRACT              = "stage_2_adapter_dry_run_contract"
STAGE_3_DRY_RUN_INPUT_VALIDATION_SIMULATION   = "stage_3_dry_run_input_validation_simulation"
STAGE_4_DRY_RUN_REQUEST_ENVELOPE              = "stage_4_dry_run_request_envelope"
STAGE_5_ENTRY_PAYLOAD_DRY_RUN_PREVIEW         = "stage_5_entry_payload_dry_run_preview"
STAGE_6_DRY_RUN_RESPONSE_SIMULATION           = "stage_6_dry_run_response_simulation"
STAGE_7_SECRET_AND_SIGNATURE_DRY_RUN_BOUNDARY = "stage_7_secret_and_signature_dry_run_boundary"
STAGE_8_STOP_CLEANUP_DRY_RUN_BOUNDARY         = "stage_8_stop_cleanup_dry_run_boundary"
STAGE_9_FORBIDDEN_EXECUTION_SURFACE_DRY_RUN   = "stage_9_forbidden_execution_surface_dry_run"
STAGE_10_FAILURE_AND_ABORT_ADAPTER_DRY_RUN    = "stage_10_failure_and_abort_adapter_dry_run"
STAGE_11_DOCUMENTATION_SYNC_REVIEW            = "stage_11_documentation_sync_review"
STAGE_12_FINAL_ADAPTER_DRY_RUN_VERDICT        = "stage_12_final_adapter_dry_run_verdict"
...
STATUS_DRY_RUN_READY_EXEC_DISABLED = (
    "TINY_GUARDED_ENTRY_REAL_EXECUTION_ADAPTER_DRY_RUN_"
    "READY_BUT_EXECUTION_DISABLED"
)
STATUS_REAL_ENTRY_NOT_IMPL = "REAL_ENTRY_EXECUTION_NOT_IMPLEMENTED"
STATUS_FAIL_CLOSED         = "FAIL_CLOSED"

MODE_DRY_RUN_CHECKLIST       = "adapter_dry_run_checklist"
MODE_DRY_RUN_APPROVAL        = "adapter_dry_run_approval"
...
ADAPTER_RESPONSE_STATUS           = "ADAPTER_DRY_RUN_NOT_SENT"
ORDER_LINK_ID_PREFIX              = "ADAPTER_DRY_RUN_TINY_ENTRY_"
...
GATE_ENTRY_ADAPTER_DESIGN_STATUS_UNACCEPTABLE = (
    "entry_adapter_design_status_unacceptable"
)
GATE_ENTRY_ADAPTER_DESIGN_READINESS_EXECUTABLE = (
    "entry_adapter_design_readiness_executable"
)
GATE_ENTRY_ADAPTER_DESIGN_GRANTS_EXECUTION = (
    "entry_adapter_design_grants_execution_true"
)
GATE_ENTRY_ADAPTER_DESIGN_IMPLEMENTATION_INCLUDED = (
    "entry_adapter_design_implementation_included_true"
)
GATE_ENTRY_ADAPTER_DESIGN_EXECUTION_INCLUDED = (
    "entry_adapter_design_execution_included_true"
)
...
# Scope gates
GATE_ADAPTER_DRY_RUN_ONLY                         = "adapter_dry_run_only"
...
GATE_CONSUMED_DESIGN_CONTRACT_VERSION_DOCUMENTED  = "consumed_design_contract_version_documented"
...
# Input validation simulation gates
...
GATE_INPUT_VALIDATION_SIMULATED_ONLY              = "input_validation_simulated_only"
GATE_INPUT_VALIDATION_NOT_AUTHORIZING             = "input_validation_does_not_authorize_execution"

# Request envelope gates
GATE_REQUEST_ENVELOPE_PREVIEW_ONLY                = "request_envelope_preview_only"
GATE_REQUEST_ENVELOPE_NOT_SENT                    = "request_envelope_not_sent"
GATE_REQUEST_ENDPOINT_PATH_REF                    = "request_endpoint_path_reference_only"
GATE_REQUEST_BASE_URL_DEMO_ONLY                   = "request_base_url_demo_only"
GATE_REQUEST_NO_SIGNATURE                         = "request_no_signature"
GATE_REQUEST_NO_PRIVATE_HEADERS                   = "request_no_private_headers"
GATE_REQUEST_NO_SECRET_VALUES                     = "request_no_secret_values"

# Payload preview gates
GATE_PAYLOAD_PREVIEW_ONLY                         = "payload_preview_only"
GATE_PAYLOAD_ADAPTER_DRY_RUN_ONLY                 = "payload_adapter_dry_run_only"
...
# Response simulation gates
GATE_RESPONSE_STATUS_ADAPTER_DRY_RUN_NOT_SENT     = "response_status_adapter_dry_run_not_sent"
GATE_RESPONSE_FROM_EXCHANGE_FALSE                 = "response_from_exchange_false"
GATE_RESPONSE_EXCHANGE_ORDER_ID_NONE              = "response_exchange_order_id_none"
GATE_RESPONSE_SIMULATED_ONLY                      = "response_simulated_only"
GATE_RESPONSE_NO_SECRETS                          = "response_no_secrets"
GATE_RESPONSE_SANITIZED                           = "response_sanitized"
GATE_RESPONSE_NO_POSITION_MODIFIED                = "response_no_position_modified"

# Secret / signature boundary gates
...
# Forbidden execution surface gates
...
GATE_ADAPTER_DESIGN_IMPLEMENTATION_INCLUDED_TRUE_FAIL_CLOSED = "adapter_design_implementation_included_true_fail_closed"
GATE_ADAPTER_DESIGN_EXECUTION_INCLUDED_TRUE_FAIL_CLOSED = "adapter_design_execution_included_true_fail_closed"
...
@dataclass
class TinyGuardedEntryRealExecutionAdapterDryRunResult:
    """Read-only outcome of one guarded entry real execution adapter dry-run."""
    timestamp_utc:                str
    mode:                         str
    selected_symbol:              str
    ...
    adapter_dry_run_scope:                  dict[str, Any] = field(default_factory=dict)
    adapter_dry_run_contract:               dict[str, Any] = field(default_factory=dict)
    dry_run_input_validation_simulation:    dict[str, Any] = field(default_factory=dict)
    dry_run_request_envelope:               dict[str, Any] = field(default_factory=dict)
    entry_payload_dry_run_preview:          dict[str, Any] = field(default_factory=dict)
    dry_run_response_simulation:            dict[str, Any] = field(default_factory=dict)
    secret_and_signature_dry_run_boundary:  dict[str, Any] = field(default_factory=dict)
    stop_cleanup_dry_run_boundary:          dict[str, Any] = field(default_factory=dict)
    forbidden_execution_surface_dry_run:    dict[str, Any] = field(default_factory=dict)
    failure_and_abort_adapter_dry_run:      dict[str, Any] = field(default_factory=dict)
    documentation_sync_review:              dict[str, Any] = field(default_factory=dict)
    audit_artifacts:                        dict[str, Any] = field(default_factory=dict)
    final_adapter_dry_run_verdict:          dict[str, Any] = field(default_factory=dict)
    ...
    adapter_dry_run_allowed:           bool = False
    real_entry_execution_requested:    bool = False
    real_execution_allowed:            bool = False
    real_entry_implemented:            bool = False
    guarded_entry_real_execution_adapter_dry_run: bool = True
    adapter_dry_run_only:              bool = True
    ...
    upstream_entry_adapter_design_readiness_conclusion: str = ""
    ...
    next_required_task:           str  = "TASK-014AP_guarded_entry_real_execution_adapter_implementation_readiness_review"
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "adapter_dry_run_scope":                     dict(self.adapter_dry_run_scope),
            "adapter_dry_run_contract":                  dict(self.adapter_dry_run_contract),
            "dry_run_input_validation_simulation":       dict(self.dry_run_input_validation_simulation),
            "dry_run_request_envelope":                  dict(self.dry_run_request_envelope),
            "entry_payload_dry_run_preview":             dict(self.entry_payload_dry_run_preview),
            "dry_run_response_simulation":               dict(self.dry_run_response_simulation),
            "secret_and_signature_dry_run_boundary":     dict(self.secret_and_signature_dry_run_boundary),
            "stop_cleanup_dry_run_boundary":             dict(self.stop_cleanup_dry_run_boundary),
            "forbidden_execution_surface_dry_run":       dict(self.forbidden_execution_surface_dry_run),
            "failure_and_abort_adapter_dry_run":         dict(self.failure_and_abort_adapter_dry_run),
            "documentation_sync_review":                 dict(self.documentation_sync_review),
            "audit_artifacts":                           dict(self.audit_artifacts),
            "final_adapter_dry_run_verdict":             dict(self.final_adapter_dry_run_verdict),
            ...
            "adapter_dry_run_allowed":                   self.adapter_dry_run_allowed,
            ...
            "guarded_entry_real_execution_adapter_dry_run":
                self.guarded_entry_real_execution_adapter_dry_run,
            "adapter_dry_run_only":                      self.adapter_dry_run_only,
            ...
            "upstream_entry_adapter_design_readiness_conclusion":
                self.upstream_entry_adapter_design_readiness_conclusion,
...
# ---------------------------------------------------------------------------
# Guarded entry real execution adapter dry-run
# ---------------------------------------------------------------------------

class DemoTinyGuardedEntryRealExecutionAdapterDryRun:
    """
    Pure-computation guarded entry real execution adapter dry-run.
    Re-reviews 24 upstream artifacts and emits the adapter-dry-run
    ...
    --allow-adapter-dry-run         --> status promoted to
    ...
    def run_review(
        ...
        expected_commit_hash:                 str  = "",
        current_commit_hash:                  str  = "",
        allow_adapter_dry_run:                bool = False,
        ...
        elif allow_adapter_dry_run:
            mode = MODE_DRY_RUN_APPROVAL
        else:
        ...
        entry_adapter_design_present = isinstance(entry_adapter_design, dict) and bool(entry_adapter_design)
        ...
        entry_adapter_design_readiness = _safe_str(
            (entry_adapter_design or {}).get("readiness_conclusion", "")
        )
        ...
        if not entry_adapter_design_present:
            blocked.append(GATE_ENTRY_ADAPTER_DESIGN_MISSING)
        ...
        if entry_adapter_design_present and entry_adapter_design_status and (
        ...
        if entry_adapter_design_present and entry_adapter_design_readiness and (
            entry_adapter_design_readiness != READINESS_CONCLUSION_NOT_EXECUTABLE
        ):
            blocked.append(GATE_ENTRY_ADAPTER_DESIGN_READINESS_EXECUTABLE)
        if entry_adapter_design_present and entry_adapter_design_grants:
            blocked.append(GATE_ENTRY_ADAPTER_DESIGN_GRANTS_EXECUTION)
        if entry_adapter_design_present and entry_adapter_design_impl:
            blocked.append(GATE_ENTRY_ADAPTER_DESIGN_IMPLEMENTATION_INCLUDED)
        if entry_adapter_design_present and entry_adapter_design_exec:
        ...
        stages[STAGE_0_ARTIFACT_PREFLIGHT] = {
            ...
            "summary": "Validate 24 upstream artifacts + runtime proof envelope + manual approval gate + AN adapter design status / readiness / grants / inclusion flags.",
            ...
            "entry_adapter_design_present":             entry_adapter_design_present,
            ...
            "entry_adapter_design_status_acceptable":   sorted(
                ACCEPTABLE_ENTRY_ADAPTER_DESIGN_STATUSES
            ),
            "entry_adapter_design_readiness_observed":  entry_adapter_design_readiness,
            "entry_adapter_design_readiness_expected":  READINESS_CONCLUSION_NOT_EXECUTABLE,
            "entry_adapter_design_grants_execution_observed": entry_adapter_design_grants,
            "entry_adapter_design_grants_execution_expected": False,
            "entry_adapter_design_implementation_included_observed": entry_adapter_design_impl,
            "entry_adapter_design_implementation_included_expected": False,
            "entry_adapter_design_execution_included_observed": entry_adapter_design_exec,
            "entry_adapter_design_execution_included_expected": False,
            "selected_symbol":                          sym,
        ...
        # stage_1_adapter_dry_run_scope
        # ===============================================================
        adapter_dry_run_scope: dict[str, Any] = {
            ...
            "scope_summary": (
                "TASK-014AO consumes TASK-014AN's adapter design output and "
                "simulates the FUTURE real tiny entry execution adapter end-"
                "to-end (input validation simulation, request envelope, "
                "payload preview, simulated response, secret-and-signature "
                "boundary, stop-cleanup boundary, forbidden surface, failure-"
                "and-abort documentation).  It does not implement the "
                "adapter, does not build any sender or private client, never "
                "validates any token / phrase / approval input, never treats "
                "them as authorization, never sends an order, never calls "
                "any endpoint, never modifies any position, never lifts G20, "
                "never loads any secret, and never auto-commits / auto-"
                "pushes git."
            ),
        }
        stages[STAGE_1_ADAPTER_DRY_RUN_SCOPE] = {
            "stage":   STAGE_1_ADAPTER_DRY_RUN_SCOPE,
            "summary": "Assert guarded entry real execution adapter dry-run scope (dry-run-only).",
            "adapter_dry_run_scope":                adapter_dry_run_scope,
        }
        blocked.append(GATE_ADAPTER_DRY_RUN_ONLY)
        ...
        # stage_2_adapter_dry_run_contract
        # ===============================================================
        adapter_dry_run_contract: dict[str, Any] = {
            "adapter_name":                         ADAPTER_NAME,
            "adapter_contract_version":             ADAPTER_CONTRACT_VERSION,
            "consumed_design_contract_version":     CONSUMED_DESIGN_CONTRACT_VERSION,
            ...
            "dry_run_only_contract_note": (
                "Contract describes the FUTURE adapter's surface and "
                "simulates a dry-run round-trip but does not include any "
                "callable send / sign / network method in this task. Any "
                "future implementation must continue to respect TASK-014L "
                "sender G20 and every documented forbidden execution "
                "surface gate."
            ),
        }
        stages[STAGE_2_ADAPTER_DRY_RUN_CONTRACT] = {
            "stage":   STAGE_2_ADAPTER_DRY_RUN_CONTRACT,
            "summary": "Adapter dry-run contract (dry-run-only; no send method / private client / signature / secret loader / network transport).",
        ...
        blocked.append(GATE_CONSUMED_DESIGN_CONTRACT_VERSION_DOCUMENTED)
        ...
        # stage_3_dry_run_input_validation_simulation
        # ===============================================================
        dry_run_input_validation_simulation: dict[str, Any] = {
            ...
            "input_validation_simulated_only":       True,
            "input_validation_does_not_authorize_execution": True,
            "validation_outcome":                    "SIMULATED_VALID_NOT_AUTHORIZED",
        }
        stages[STAGE_3_DRY_RUN_INPUT_VALIDATION_SIMULATION] = {
            "stage":   STAGE_3_DRY_RUN_INPUT_VALIDATION_SIMULATION,
            "summary": "Dry-run input validation simulation (simulated only; does not authorize execution).",
            "dry_run_input_validation_simulation":  dry_run_input_validation_simulation,
        }
        ...
        blocked.append(GATE_INPUT_VALIDATION_SIMULATED_ONLY)
        blocked.append(GATE_INPUT_VALIDATION_NOT_AUTHORIZING)

        # ===============================================================
        # stage_4_dry_run_request_envelope
        # ===============================================================
        dry_run_request_envelope: dict[str, Any] = {
            "preview_only":                          True,
            ...
            "method":                                "POST",
            "headers_public_only":                   ["Content-Type: application/json"],
            "private_headers":                       [],
            "signature_present":                     False,
            "no_secret_values":                      True,
        }
        stages[STAGE_4_DRY_RUN_REQUEST_ENVELOPE] = {
            "stage":   STAGE_4_DRY_RUN_REQUEST_ENVELOPE,
            "summary": "Dry-run request envelope (preview only; not sent; no signature; no private headers).",
            "dry_run_request_envelope":             dry_run_request_envelope,
        }
        blocked.append(GATE_REQUEST_ENVELOPE_PREVIEW_ONLY)
        blocked.append(GATE_REQUEST_ENVELOPE_NOT_SENT)
        blocked.append(GATE_REQUEST_ENDPOINT_PATH_REF)
        blocked.append(GATE_REQUEST_BASE_URL_DEMO_ONLY)
        blocked.append(GATE_REQUEST_NO_SIGNATURE)
        blocked.append(GATE_REQUEST_NO_PRIVATE_HEADERS)
        blocked.append(GATE_REQUEST_NO_SECRET_VALUES)

        # ===============================================================
        # stage_5_entry_payload_dry_run_preview
        # ===============================================================
        sym_eff = sym or DESIGN_EXPECTED_SYMBOL
        entry_payload_dry_run_preview: dict[str, Any] = {
            "preview_only":                          True,
            "adapter_dry_run_only":                  True,
            "send_allowed":                          False,
        ...
        stages[STAGE_5_ENTRY_PAYLOAD_DRY_RUN_PREVIEW] = {
            "stage":   STAGE_5_ENTRY_PAYLOAD_DRY_RUN_PREVIEW,
            "summary": "Entry payload dry-run preview (dry-run-only; never sent; never signed; sender adapter not invoked).",
            "entry_payload_dry_run_preview":        entry_payload_dry_run_preview,
        }
        blocked.append(GATE_PAYLOAD_PREVIEW_ONLY)
        blocked.append(GATE_PAYLOAD_ADAPTER_DRY_RUN_ONLY)
        ...
        # stage_6_dry_run_response_simulation
        # ===============================================================
        dry_run_response_simulation: dict[str, Any] = {
        ...
        stages[STAGE_6_DRY_RUN_RESPONSE_SIMULATION] = {
            "stage":   STAGE_6_DRY_RUN_RESPONSE_SIMULATION,
            "summary": "Dry-run response simulation (simulated only; never executes; no exchange response).",
            "dry_run_response_simulation":          dry_run_response_simulation,
        }
        blocked.append(GATE_RESPONSE_STATUS_ADAPTER_DRY_RUN_NOT_SENT)
        blocked.append(GATE_RESPONSE_FROM_EXCHANGE_FALSE)
        blocked.append(GATE_RESPONSE_EXCHANGE_ORDER_ID_NONE)
        blocked.append(GATE_RESPONSE_SIMULATED_ONLY)
        blocked.append(GATE_RESPONSE_NO_SECRETS)
        blocked.append(GATE_RESPONSE_SANITIZED)
        blocked.append(GATE_RESPONSE_NO_POSITION_MODIFIED)

        # ===============================================================
        # stage_7_secret_and_signature_dry_run_boundary
        # ===============================================================
        secret_and_signature_dry_run_boundary: dict[str, Any] = {
        ...
        stages[STAGE_7_SECRET_AND_SIGNATURE_DRY_RUN_BOUNDARY] = {
            "stage":   STAGE_7_SECRET_AND_SIGNATURE_DRY_RUN_BOUNDARY,
            "summary": "Secret / signature dry-run boundary (no secrets loaded; no signing; future-task only).",
            "secret_and_signature_dry_run_boundary": secret_and_signature_dry_run_boundary,
        }
        ...
        # stage_8_stop_cleanup_dry_run_boundary
        # ===============================================================
        stop_cleanup_dry_run_boundary: dict[str, Any] = {
        ...
        stages[STAGE_8_STOP_CLEANUP_DRY_RUN_BOUNDARY] = {
            "stage":   STAGE_8_STOP_CLEANUP_DRY_RUN_BOUNDARY,
            "summary": "Stop attach / cleanup dry-run boundary (separate manual boundaries; future adapter must not auto-attach).",
            "stop_cleanup_dry_run_boundary":        stop_cleanup_dry_run_boundary,
        }
        ...
        # stage_9_forbidden_execution_surface_dry_run
        # ===============================================================
        forbidden_execution_surface_dry_run: dict[str, Any] = {
            "no_real_sender":                        True,
        ...
        stages[STAGE_9_FORBIDDEN_EXECUTION_SURFACE_DRY_RUN] = {
            "stage":   STAGE_9_FORBIDDEN_EXECUTION_SURFACE_DRY_RUN,
            "summary": "Forbidden execution surface dry-run (no sender / private client / signed request / network / automation / executable adapter / send method).",
            "forbidden_execution_surface_dry_run":  forbidden_execution_surface_dry_run,
        }
        ...
        failure_and_abort_adapter_dry_run: dict[str, Any] = {
            ...
            "adapter_design_implementation_included_true": "FAIL_CLOSED",
            "adapter_design_execution_included_true": "FAIL_CLOSED",
        ...
        stages[STAGE_10_FAILURE_AND_ABORT_ADAPTER_DRY_RUN] = {
            "stage":   STAGE_10_FAILURE_AND_ABORT_ADAPTER_DRY_RUN,
            "summary": "Failure / abort adapter dry-run (FAIL_CLOSED / MANUAL_REVIEW_REQUIRED only; no auto-progression).",
            "failure_and_abort_adapter_dry_run":    failure_and_abort_adapter_dry_run,
        }
        ...
        blocked.append(GATE_ADAPTER_DESIGN_IMPLEMENTATION_INCLUDED_TRUE_FAIL_CLOSED)
        blocked.append(GATE_ADAPTER_DESIGN_EXECUTION_INCLUDED_TRUE_FAIL_CLOSED)
        ...
        stages[STAGE_11_DOCUMENTATION_SYNC_REVIEW] = {
            "stage":   STAGE_11_DOCUMENTATION_SYNC_REVIEW,
        ...
        if hard_fail:
            ...
            mode_out   = MODE_DRY_RUN_APPROVAL
        else:
            failed_stage = ""
            status_out = STATUS_DRY_RUN_READY
            mode_out   = MODE_DRY_RUN_CHECKLIST

        final_adapter_dry_run_verdict: dict[str, Any] = {
            "adapter_dry_run_allowed":               allow_adapter_dry_run,
        ...
        audit_artifacts: dict[str, Any] = {
            "adapter_dry_run_scope":                 dict(adapter_dry_run_scope),
            "adapter_dry_run_contract":              dict(adapter_dry_run_contract),
            "dry_run_input_validation_simulation":   dict(dry_run_input_validation_simulation),
            "dry_run_request_envelope":              dict(dry_run_request_envelope),
            "entry_payload_dry_run_preview":         dict(entry_payload_dry_run_preview),
            "dry_run_response_simulation":           dict(dry_run_response_simulation),
            "secret_and_signature_dry_run_boundary": dict(secret_and_signature_dry_run_boundary),
            "stop_cleanup_dry_run_boundary":         dict(stop_cleanup_dry_run_boundary),
            "forbidden_execution_surface_dry_run":   dict(forbidden_execution_surface_dry_run),
            "failure_and_abort_adapter_dry_run":     dict(failure_and_abort_adapter_dry_run),
            "documentation_sync_review":             dict(documentation_sync_review),
            "final_adapter_dry_run_verdict":         dict(final_adapter_dry_run_verdict),
            "response_status":                       ADAPTER_RESPONSE_STATUS,
            "response_from_exchange":                False,
            "sanitized":                             True,
            "no_secrets":                            True,
        ...
        stages[STAGE_12_FINAL_ADAPTER_DRY_RUN_VERDICT] = {
            "stage":   STAGE_12_FINAL_ADAPTER_DRY_RUN_VERDICT,
            "summary": "Final adapter dry-run verdict + permanent execution guard.",
            "final_adapter_dry_run_verdict":        final_adapter_dry_run_verdict,
        }

        return TinyGuardedEntryRealExecutionAdapterDryRunResult(
            ...
            upstream_entry_adapter_design_readiness_conclusion=entry_adapter_design_readiness,
...
__all__ = [
    ...
    "GATE_CONSUMED_DESIGN_CONTRACT_VERSION_DOCUMENTED",
    ...
    "GATE_INPUT_VALIDATION_SIMULATED_ONLY",
    "GATE_INPUT_VALIDATION_NOT_AUTHORIZING",
    "GATE_REQUEST_ENVELOPE_PREVIEW_ONLY",
    "GATE_REQUEST_ENVELOPE_NOT_SENT",
    "GATE_REQUEST_ENDPOINT_PATH_REF",
    "GATE_REQUEST_BASE_URL_DEMO_ONLY",
    "GATE_REQUEST_NO_SIGNATURE",
    "GATE_REQUEST_NO_PRIVATE_HEADERS",
    "GATE_REQUEST_NO_SECRET_VALUES",
    "GATE_PAYLOAD_PREVIEW_ONLY",
    "GATE_PAYLOAD_ADAPTER_DRY_RUN_ONLY",
    ...
    "GATE_RESPONSE_STATUS_ADAPTER_DRY_RUN_NOT_SENT",
    "GATE_RESPONSE_FROM_EXCHANGE_FALSE",
    "GATE_RESPONSE_EXCHANGE_ORDER_ID_NONE",
    "GATE_RESPONSE_SIMULATED_ONLY",
    "GATE_RESPONSE_NO_SECRETS",
    "GATE_RESPONSE_SANITIZED",
    "GATE_RESPONSE_NO_POSITION_MODIFIED",
    ...
    "GATE_ADAPTER_DESIGN_IMPLEMENTATION_INCLUDED_TRUE_FAIL_CLOSED",
    "GATE_ADAPTER_DESIGN_EXECUTION_INCLUDED_TRUE_FAIL_CLOSED",
    "GATE_SOLUSDT_EXISTS_FAIL_CLOSED",
